...
return [
    ...
    */
    ...
    'providers' => [
        ...
        // new packages
        Webkul\Area\Providers\AreaServiceProvider::class,
        Webkul\Driver\Providers\DriverServiceProvider::class,
        Webkul\Motor\Providers\MotorServiceProvider::class,
        Webkul\Brand\Providers\BrandServiceProvider::class,
        Webkul\Supplier\Providers\SupplierServiceProvider::class,
        Webkul\Purchase\Providers\PurchaseServiceProvider::class,
        Webkul\Collector\Providers\CollectorServiceProvider::class,
        Webkul\Banner\Providers\BannerServiceProvider::class,
        Webkul\Promotion\Providers\PromotionServiceProvider::class,
        \Webkul\Bundle\Providers\BundleServiceProvider::class,
