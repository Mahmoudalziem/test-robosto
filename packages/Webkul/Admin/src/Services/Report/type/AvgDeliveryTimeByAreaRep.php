...
class AvgDeliveryTimeByAreaRep {

    public $name;
    protected $data;

    public function __construct(array $data) {
        $this->name = "avg-delivery-time-by-area";
        $this->data = $data;
    }
    ...
    public function getHeaddings() {
        return ['#', 'area_name', 'total_delivery_minutes', 'number_of_orders', 'average_delivery_time'];
    }
